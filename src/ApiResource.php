 ...
 * Class ApiResource.
 */
abstract class ApiResource extends PaystackObject
{
    use ApiOperations\Request;

    /**
     * @return \Paystack\Util\Set A list of fields that can be their own type of
    ...
    public static function resourceUrl($id)
    {
        if (null === $id) {
            ...
            throw UnexpectedValue::badValue($message);
        }
        $id = Util::utf8($id);
