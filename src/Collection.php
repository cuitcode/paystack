...
use Cuitcode\Paystack\ApiOperations\Request;
 ...
 * @property \Paystack\PaystackObject[] $data
 */
class Collection extends PaystackObject implements \Countable, \IteratorAggregate
{
    ...
    public function offsetGet($k)
    {
        ...
        throw InvalidArgument::badArgument($msg);
    }
    ...
    public function all($params = null, $opts = null)
    {
        ...
        $obj = Util::convertToPaystackObject($response, $opts);
    ...
    public function create($params = null, $opts = null)
    {
        ...
        return Utils::convertToPaystackObject($response, $opts);
    }
    ...
    /**
     * @return \Generator|PaystackObject[] A generator that can be used to
    ...
    private function extractPathAndUpdateParams($params)
    {
        ...
        if (!isset($url['path'])) {
            throw UnexpectedValueException::badValue("Could not parse list url into parts: {$url}");
        }
